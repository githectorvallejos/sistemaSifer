    ...
    return (
      ...
      <Table aria-label="collapsible table">
        <TableHead>
          <TableRow>
            <TableCell />
            <TableCell>Fecha Ultima Carga</TableCell>
            <TableCell align="center">Carga Inicial&nbsp;(Lts)</TableCell>
            <TableCell align="center">Estado Final&nbsp;(Lts)</TableCell>
            <TableCell align="center">Total Descarga&nbsp;(Kgs)</TableCell>
            <TableCell align="center">Presión&nbsp;(bar)</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {rows.map((row) => (
